  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="form-inline my-2 my-lg-0">
          ...
          <a href="http://localhost/powerofstar/acess/logout.php" alt='Broken Link'>Deslogar</a>
      <div>
    </div>
  </div>
</nav>
...
<?php
    ...
    $webuser = str_replace("powerofstar/acess/user.php/", "", $_SERVER["REQUEST_URI"]);
...
<?php else: header("Location: http://localhost/powerofstar/acess/login.php"); endif; ?>