...
<html lang="pt-br">
  <head>
    ...
    <title>Power of Star - Singup</title>
  ...
  <body style="background-color:#181414;"
    ...
    >
      ...
      <div class="content">
        <div class="text">
       <form class="form-singin" action="cadastrar.php" method="POST">
         <div class="card">
           <div class="card-top">
             ...
             >
               <a style="text-align: center" href="login.php">Já tem uma conta?</a>
                 <div>
           ...
           <div class="card-group">
             ...
             <input type="text" name="user" id="inputUser" class="form-control" placeholder="Digite seu username" required>
            </div>
